...
customize the resulting theme."
  ...
  (let* ((class '((class color) (min-colors 89)))
    ...
    (custom-theme-set-faces
     ...
     `(icicle-Completions-instruction-1 ((,class (:foreground ,yellow :weight bold))))
     `(icicle-Completions-instruction-2 ((,class (:foreground ,blue))))
     `(icicle-annotation ((,class (:foreground ,base0 ))))
     `(icicle-candidate-part ((,class (:weight bold :foreground ,magenta))))
     `(icicle-common-match-highlight-Completions ((,class (:foreground ,green
                                                           :background ,solarized-hl))))
     `(icicle-complete-input ((,class (:foreground ,violet))))
     `(icicle-completion ((,class (:foreground ,blue))))
     `(icicle-current-candidate-highlight ((,class (:foreground ,orange
                                                    :background ,solarized-hl))))
     `(icicle-extra-candidate ((,class (:foreground ,yellow))))
     `(icicle-historical-candidate ((,class (:foreground ,orange))))
     `(icicle-historical-candidate-other ((,class (:foreground ,green))))
     `(icicle-input-completion-fail ((,class (:foreground ,red))))
     `(icicle-input-completion-fail-lax ((,class (:foreground ,red))))
     `(icicle-key-complete-menu ((,class ( :background ,magenta :foreground ,solarized-fg))))
     `(icicle-key-complete-menu-local ((,class ( :background ,blue) :foreground ,solarized-fg)))
     `(icicle-match-highlight-Completions ((,class ( :background ,solarized-hl :foreground ,green))))
     `(icicle-match-highlight-minibuffer ((,class ( :background ,solarized-hl :foreground ,cyan))))
     `(icicle-mode-line-help ((,class (:foreground ,yellow))))
     `(icicle-msg-emphasis ((,class (:foreground ,red :weight bold))))
     `(icicle-multi-command-completion ((,class (:foreground ,solarized-fg :background ,blue))))
     `(icicle-mustmatch-completion ((,class ( :background ,violet))))
     `(icicle-proxy-candidate ((,class (:foreground ,orange))))
     `(icicle-saved-candidate ((,class (:background ,solarized-hl))))
     `(icicle-search-context-level-1 ((,class (:foreground ,solarized-fg :background ,green))))
     `(icicle-search-context-level-2 ((,class (:foreground ,solarized-fg :background ,red))))
     `(icicle-search-context-level-3 ((,class (:foreground ,solarized-fg :background ,orange))))
     `(icicle-search-context-level-4 ((,class (:foreground ,solarized-fg :background ,yellow))))
     `(icicle-search-context-level-5 ((,class (:foreground ,solarized-fg :background ,green-d))))
     `(icicle-search-context-level-6 ((,class (:foreground ,solarized-fg :background ,red-d))))
     `(icicle-search-context-level-7 ((,class (:foreground ,solarized-fg :background ,orange-d))))
     `(icicle-search-context-level-8 ((,class (:foreground ,solarized-fg :background ,yellow-d))))
     `(icicle-search-current-input ((,class (:background ,magenta))))
     `(icicle-search-main-regexp-current ((,class (:background ,cyan))))
     `(icicle-search-main-regexp-others ((,class (:background ,red))))
     `(icicle-special-candidate ((,class (:background ,blue))))
     `(icicle-whitespace-highlight ((,class (:background ,green))))
